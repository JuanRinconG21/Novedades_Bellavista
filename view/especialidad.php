...
$sql = "SELECT * FROM especialidad WHERE estado=0";
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    function ejecutarControladorEliminar(id) {
        ...
        $.ajax({
            url: '../controller/eliminarEspecialidad.php', // Ajusta la ruta a tu controlador PHP
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" style="font-weight: bold;">Agregar Especialidad</h2>
              ...
              ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-danger"
                                                onclick="eliminarEspecialidad(<?php echo $key['idEspecialidad'] ?>)"><i
                                                    class="fas fa-trash-alt"></i></a> </td>
                                        <td><a class="btn btn-warning" data-toggle="modal"
                                                data-target="#modal-default<?php echo $key['idEspecialidad'] ?>"><i
                                                    class="fas fa-edit"></i></a> </td>
                                        <div class="modal fade" id="modal-default<?php echo $key['idEspecialidad'] ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
