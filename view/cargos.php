...
$sql = "SELECT * FROM cargos WHERE estado=0";
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title " style="font-weight: bold;">Agregar Cargo</h2>
              ...
              ?>
                                    <tr class="text-center">
                                        ...
                                        <td><a class="btn btn-danger"
                                                onclick="eliminarCargo(<?php echo $key['idCargos'] ?>)"><i
                                                    class="fas fa-trash-alt"></i></a> </td>
                                        <td><a class="btn btn-warning" data-toggle="modal"
                                                data-target="#modal-default<?php echo $key['idCargos'] ?>"><i
                                                    class="fas fa-edit"></i></a> </td>
                                        <div class="modal fade" id="modal-default<?php echo $key['idCargos'] ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h2 class="modal-title" style="font-weight: bold;">Editar Cargo
                                                        </h2>
